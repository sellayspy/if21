    ...
    <div class="col-12">
        ...
        <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-header">
                <div class="card-title">Form Ubah Jadwal</div>
            </div>
            <!--end::Header-->
            <!--begin::Form-->
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="kode_smt" id="kode_smt" class="form-control">
                            ...
                            <option value="Gasal" {{ old('kode_smt', $jadwal->kode_smt) == 'Gasal' ? 'selected' : '' }}>Gasal</option>
                            <option value="Genap" {{ old('kode_smt', $jadwal->kode_smt) == 'Genap' ? 'selected' : '' }}>Genap</option>
                        </select>
                        @error('kode_smt')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select name="mata_kuliah_id" class="form-control">
                            ...
                            @foreach ($mataKuliah as $item)
                                <option value="{{ $item->id }}" {{ old('mata_kuliah_id', $jadwal->mata_kuliah_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="dosen_id" class="form-control">
                            ...
                            @foreach ($dosen as $item)
                                <option value="{{ $item->id }}" {{ old('dosen_id', $jadwal->dosen_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="sesi_id" class="form-control">
                            ...
                            @foreach ($sesi as $item)
                                <option value="{{ $item->id }}" {{ old('sesi_id', $jadwal->sesi_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
